...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header className={`${isDesktop ? 'relative' : 'fixed top-0 left-0 right-0 z-50'} bg-gradient-to-b from-sky-300/90 via-blue-400/90 to-cyan-500/90 dark:from-slate-700/90 dark:via-slate-600/90 dark:to-slate-500/90 border-b border-border/40 backdrop-blur-md`}>
      <div className="flex flex-col">
        ...
        <div className={`flex items-center justify-between px-4 ${isDesktop ? 'h-12' : 'h-14'}`}>
          ...
          >
            ...
            <h1 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Cloud Memo</h1>
          </div>
        ...
        {/* 상태 표시 바 - PC 모드에서만 표시 */}
        {isDesktop && (
          <div className="flex items-center justify-between px-4 py-1 bg-sky-200/80 dark:bg-slate-600/80 backdrop-blur-sm border-t border-border/20">
